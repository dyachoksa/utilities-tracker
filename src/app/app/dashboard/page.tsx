...
import { PaymentOverview } from "~/components/blocks/dashboard/payment-overview";
  ...
  return (
    <>
      ...
      <section className="@container/main grid grid-cols-1 gap-6 p-4 md:grid-cols-2 md:gap-8 md:p-6 lg:grid-cols-3">
        <ChartPaymentsByType className="lg:row-span-2" />

        <PaymentOverview className="lg:col-span-2" />
